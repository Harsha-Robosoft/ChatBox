...
struct ChatWidgetLiveActivity_Previews: PreviewProvider {
    static let attributes = ChatWidgetAttributes(name: "Me")
    static let contentState = ChatWidgetAttributes.ContentState(value: 3)
